 ...
 * CHANGE: Added Routines tab with RefreshCw icon
 * Nav: Home | Routines | Tasks (FAB) | Calendar | More
 */
import { motion, AnimatePresence } from 'framer-motion'
import { LayoutDashboard, CheckSquare, Settings, Bell, Calendar, RefreshCw } from 'lucide-react'
import { useUIStore } from '@/store'
import { useNotificationStore } from '@/store/notificationStore'
